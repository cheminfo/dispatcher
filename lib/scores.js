...
function humidity(deviceId) {
    var device = config.findDeviceById(deviceId);
    var param = config.getParamByName(deviceId, 'humidity');
...
function luminosity(deviceId) {
    var dayLuminosity = 400 / 0.04;
    var device = config.findDeviceById(deviceId);
    var param = config.getParamByName(deviceId, 'luminosity');
